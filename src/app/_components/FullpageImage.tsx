...
import { PhotoViewTracker } from "~/app/_components/PhotoViewTracker";
...
export default async function FullpageImage(props:{photoId:string}){
    ...
    return (
        <>
            <PhotoViewTracker photoId={props.photoId} />
            <div className="bg-gray-900/85 rounded-lg shadow-xl overflow-hidden flex flex-col md:flex-row border border-gray-700">
                {/* 照片顯示區域 - 左側 */}
